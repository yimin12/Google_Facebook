...
public class WaterDistributionInVillageKruskal {


    public int minCostToSupplyWater(int n, int[] wells, int[][] pipes){
        WeightedGraph g = new WeightedGraph(n + 1); // create a dummy root
    ...
    public static void main(String[] args){
        ...
        System.out.println((new WaterDistributionInVillageKruskal()).minCostToSupplyWater(3, wells, pipes));
    }
}
