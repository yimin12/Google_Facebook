 ...
 *   @Date : 2021/1/11 12:04
 *   @Description :
 *
 */
public class WaterDistributionVillageKruskalPrim {
    ...
    public int minCostToSupplyWater(int n, int[] wells, int[][] pipes){
        ...
        for(int i = 0; i < pipes.length; i ++){
            graph.addEdge(pipes[i][0], pipes[i][1], pipes[i][2]);
        }
    ...
    public class Prim {
        ...
        public Prim(WeightedGraph G){
            ...
            while(!pq.isEmpty()){
                ...
                if(visited[minEdge.getV()] && visited[minEdge.getW()]) // 不是横切边
                    continue;
                mst.add(minEdge);
