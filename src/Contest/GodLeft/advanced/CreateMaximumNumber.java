...
/**
 * 给两个长度分别为M和N的整型数组nums1和nums2，其中每个值都不大于9，再给定一个正数K。 你可以在nums1和nums2中挑选数字，要求一共挑选K个，并且要从左到右挑。返回所有可能的 结果中，代表最大数字的结果
 * Example 1:                        Example 2:                   Example 3
 * Input:                            Input:                       Input:
 * nums1 = [3, 4, 6, 5]              nums1 = [6, 7]               nums1 = [3, 9]
 * nums2 = [9, 1, 2, 5, 8, 3]        nums2 = [6, 0, 4]            nums2 = [8, 9]
 * k = 5                             k = 5                        k = 3
