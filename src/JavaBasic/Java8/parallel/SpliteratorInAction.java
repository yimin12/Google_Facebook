...
public class SpliteratorInAction {
    ...
    public static void main(String[] args) {
        ...
        // use self-defined spliterator to invoke parallel stream
...
//                .forEach(null);
    ...
    static class MySpliteratorText {
        ...
        private class MySpliterator implements Spliterator<String> {
            ...
            /**
             * pick element one by one from the stream
             * @param action
             * @return
             */
            @Override
            ...
            public Spliterator<String> trySplit() {
                ...
                int left = start;
                int right = start + mid;
                start = start + mid + 1; // update global variable
