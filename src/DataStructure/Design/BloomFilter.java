 ...
 *   @Date : 2020/11/13 22:22
 *   @Description :
 *      A generic bloom filter implementation that supports any hash function(s)
 */
public class BloomFilter {

    // The number of bitsets. This should be proportional to the number of hash-functions for this bloom filter
    private final int N_SETS;
    // 2D array containing the bitsets
    private final long[][] bitsets;
    // Track the size of the bitsets in bloom filter
    ...
    // Construct bloom filter with a various bitsets of different size
    ...
    // Add a hash value to one of the bitsets in this bloom filter
    ...
    // Adds a group of related hash values to the bloom filter. These hash values should be the hash values that were applied to all the various hash functions on the same key
